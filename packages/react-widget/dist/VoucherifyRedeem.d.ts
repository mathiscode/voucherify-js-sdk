...
import { ClientSideRedeemResponse, VoucherifyClientSideOptions } from '@voucherify/sdk';
...
export declare function VoucherifyRedeem({ apiUrl, clientApplicationId, clientSecretKey, trackingId, origin, classInvalid, classInvalidAnimation, classValid, classValidAnimation, logoSrc, logoAlt, onRedeemed, onError, amount, textPlaceholder, amountPlaceholder, textRedeem, }: VoucherifyRedeemOptions): JSX.Element;
export {};
