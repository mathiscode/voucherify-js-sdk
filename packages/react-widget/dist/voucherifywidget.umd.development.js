(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@voucherify/sdk')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@voucherify/sdk'], factory) :
  (global = global || self, factory(global.VoucherifyWidget = {}, global.React, global.VoucherifySDK));
}(this, (function (exports, React, sdk) { 'use strict';
  ...
  function useVoucherifyClient(options) {
    var _useState = React.useState(function () {
      return sdk.VoucherifyClientSide(options);
    }),
        client = _useState[0],
    ...
    React.useEffect(function () {
      setClient(sdk.VoucherifyClientSide(options));
  ...
  function useVoucherifyValidateInputs() {
    var _useState = React.useState(getEmptyInputs),
        input = _useState[0],
        setInput = _useState[1];

    var _useState2 = React.useState(getEmptyInputState),
    ...
    var resetInputs = React.useCallback(function reset() {
  ...
  function VoucherifyValidate(_ref) {
    ...
    var onSubmit = React.useCallback(function onSubmit(_event) {
      setInput(function (prev) {
    ...
    }, React.createElement(VoucherifyLogo, {
      src: logoSrc,
      alt: logoAlt
  ...
  function useVoucherifyPublishInputs() {
    var _useState = React.useState(getEmptyInputs$1),
        input = _useState[0],
        setInput = _useState[1];

    var _useState2 = React.useState(getEmptyInputState$1),
  ...
  function VoucherifyPublish(_ref) {
    ...
    }) && createInput('country', customerCountryPlaceholder)), React.createElement("input", {
      type: "hidden",
      name: "voucherifyTracking",
      value: input['voucherifyTracking'],
      className: "voucherifyTracking"
  ...
  function useVoucherifyRedeemInputs() {
    var _useState = React.useState(getEmptyInputs$2),
        input = _useState[0],
        setInput = _useState[1];

    var _useState2 = React.useState(getEmptyInputState$2),
        inputStates = _useState2[0],
        setInputState = _useState2[1];

    var _useState3 = React.useState(getEmptyValidInputState),
  ...
  function useVoucherifySubscribeInputs() {
    var _useState = React.useState(getEmptyInputs$3),
        input = _useState[0],
        setInput = _useState[1];

    var _useState2 = React.useState(getEmptyInputState$3),
        inputStates = _useState2[0],
        setInputState = _useState2[1];
  ...
  function VoucherifySubscribe(_ref) {
    ...
    var onRender = React.useCallback(function _onRender() {
    ...
    return React.createElement("div", {
      ...
      className: "loader"
    }, "Loading consents...") : React.createElement(React.Fragment, null, customerFields.some(function (val) {
      return val.name === 'name';
    }) && createInput('name', (_customerFields$find = customerFields.find(function (field) {
      return field.name === 'name';
    })) == null ? void 0 : _customerFields$find.placeholder), React.createElement("div", {
      className: "voucherifyRow",
      style: {
        display: visible ? 'flex' : 'none'
      }
    ...
    })) == null ? void 0 : _customerFields$find8.placeholder)), React.createElement("div", {
    ...
    }, React.createElement("p", null, input['voucherifySubscribeStatus'])), !enableDoubleOptIn && loadedConsents.length !== 0 && loadedConsents.map(function (consent) {
      return React.createElement(React.Fragment, null, classNames.some(function (val) {
      ...
      }, consent.description, React.createElement("input", {
        type: "checkbox",
        id: consent.name,
        name: consent.id,
        onChange: onInputChange,
  ...
  exports.VoucherifyPublish = VoucherifyPublish;
  exports.VoucherifyRedeem = VoucherifyRedeem;
  exports.VoucherifySubscribe = VoucherifySubscribe;
  exports.VoucherifyValidate = VoucherifyValidate;

  Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=voucherifywidget.umd.development.js.map
